...
output "container_registry_token_passwords_password1" {
  ...
  value       = { for k, v in azurerm_container_registry_token_password.container_registry_token_passwords : k => v.password1 if v.password1 != null && length(v.password1) > 0 }
  sensitive   = true
}
output "container_registry_token_passwords_password2" {
  ...
  value       = { for k, v in azurerm_container_registry_token_password.container_registry_token_passwords : k => v.password2 if v.password2 != null && length(v.password2) > 0 }
  sensitive   = true
}
